...
//	gtk_container_add(GTK_CONTAINER(frame), vbox);
	...
	gtk_widget_set_tooltip_text(check_sound, _("Use internal routine to play sound. Valid only on windows."));
	...
	gtk_widget_set_tooltip_text(entry_wave, _("External command to play WAVE sound. %f will be replaced by data file name."));
...
//	gtk_widget_set_size_request( label, 120, 20 );
	...
	gtk_widget_set_tooltip_text(entry_mpeg, _("External command to play MPEG movie. %f will be replaced by data file name."));
...
//	gtk_widget_set_size_request( label, 120, 20 );
	...
	gtk_widget_set_tooltip_text(entry_browser, _("External command to launch Web browser. %f will be replaced by URL."));
...
//	gtk_widget_set_size_request( label, 120, 20 );
	...
	gtk_widget_set_tooltip_text(entry_open, _("Standard command to open file. %f will be replaced by filename, %l by line number."));
